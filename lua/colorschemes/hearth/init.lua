...
hl('@constructor', { fg = c.accent.slate, italic = true })
hl('@constant', { fg = c.accent.sand })
...
hl('@operator', { fg = c.accent.taupe })
hl('@function', { fg = c.accent.honey, italic = true })
hl('@function.builtin', { fg = c.accent.honey, italic = true })
hl('@function.call', { fg = c.accent.honey, italic = true })
hl('@function.method', { fg = c.accent.honey, italic = true })
hl('@function.macro', { fg = c.accent.rust, italic = true })
hl('@namespace', { fg = c.accent.rust })
hl('@module', { fg = c.accent.rust })
...
hl('@lsp.type.function', { fg = c.accent.honey, italic = true })
hl('@lsp.type.method', { fg = c.accent.honey, italic = true })
...
hl('@lsp.type.namespace', { fg = c.accent.rust })
...
hl('@lsp.type.macro', { fg = c.accent.rust, italic = true })
hl('@lsp.type.selfParameter', { fg = c.accent.rust })
hl('@lsp.type.builtinConstant', { fg = c.accent.sand })
hl('@lsp.type.magicFunction', { fg = c.accent.honey, italic = true })
...
hl('@lsp.typemod.function.builtin', { fg = c.accent.honey, italic = true })
hl('@lsp.typemod.function.defaultLibrary', { fg = c.accent.honey, italic = true })
hl('@lsp.typemod.method.defaultLibrary', { fg = c.accent.honey, italic = true })
hl('@lsp.typemod.variable.injected', { fg = c.accent.moss })
hl('@lsp.typemod.function.readonly', { fg = c.accent.honey, bold = true, italic = true })
...
hl('NvimTreeOpenedFile', { fg = c.accent.moss })
